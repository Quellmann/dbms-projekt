...
// The page a teacher sees when they click the "Edit" button on a Quiz from the
// QuizCourseList or QuizOverview pages

// There is no "Quiz" model; a quiz is just made up of the QuizQuestions and Answers
// related to the given lecture.

// Will also re-hydrate to allow for editing
